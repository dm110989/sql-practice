...
Какая колонка останется строками.
...
Значит, строки будут строиться по именам:
...
Какая колонка станет новыми колонками.
...
Значит, значения из колонки `month` станут названиями новых колонок:
...
Какие значения попадут внутрь таблицы.
...
Значит, в ячейки попадут значения зарплаты:
